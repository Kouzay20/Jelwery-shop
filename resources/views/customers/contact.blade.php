                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <button class="dropdown-item" href="{{url('customers/register')}}" type="button">Sign in</button>
                            <button class="dropdown-item" href="{{url('customers/login')}}"type="button">Sign up</button>
                        </div>
                    </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{url('customers/index')}}" class="nav-item nav-link">Home</a>
                            ...
                            <a href="{{url('customers/contact')}}" class="nav-item nav-link active">Contact</a>
                        </div>
